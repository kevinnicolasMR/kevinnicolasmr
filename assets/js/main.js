...
const botonOcultarAboutme = document.getElementById('botonOcultarAboutme');


botonOcultarAboutme.addEventListener('click',()=>{
  console.log('boton de apagado en aboutme clickeado');
})
